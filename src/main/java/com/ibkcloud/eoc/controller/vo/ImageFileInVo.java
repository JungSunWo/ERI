...
public class ImageFileInVo extends IbkCldEocDto {
    
    // 기본 정보
    private Long imgFileSeq;                // 이미지 파일 일련번호
    
    @NotNull(message = "이미지 게시판 일련번호는 필수입니다.")
    private Long imgBrdSeq;                 // 이미지 게시판 일련번호
    
    @Size(max = 200, message = "이미지 파일명은 200자를 초과할 수 없습니다.")
    ...
    @Size(max = 500, message = "이미지 텍스트는 500자를 초과할 수 없습니다.")
