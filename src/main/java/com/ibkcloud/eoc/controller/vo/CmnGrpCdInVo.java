...
public class CmnGrpCdInVo extends IbkCldEocDto {
    ...
    @Size(max = 100, message = "그룹 코드명은 100자를 초과할 수 없습니다.")
    private String grpCdNm;              // 그룹 코드명
    
    @Size(max = 200, message = "그룹 코드 설명은 200자를 초과할 수 없습니다.")
    private String grpCdDesc;            // 그룹 코드 설명
